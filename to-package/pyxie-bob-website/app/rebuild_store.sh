...
# This clears out all of the store for the PyxieBob app, and creates a nice
# new empty store.
...
# These next two ONLY WORK ON Django 1.7
    ...
    rm -rf ~/Documents/pyxie-bob-store
    cp -rvf ~/Documents/pyxie-bob-store_empty ~/Documents/pyxie-bob-store
fi
