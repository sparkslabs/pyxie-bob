...
# This file contains all of the PyxieBob specific settings
...
try:
    ...
    STORE_BASE = "/home/michael/PyxieBob/MiniMicro/website/website/pyxie-bob-store"
    DJANGO_BASE = "/home/michael/PyxieBob/MiniMicro/website/website/app"
except ImportError:
    # Are we running on the shared dev server?
    try:
        import sparkslabs
        STORE_BASE = "/srv/Websites/minimicro.iotoy.org/website/pyxie-bob-store"
        ...
        try:
            ...
            STORE_BASE = "/srv/projects/pyxiebob/website/pyxie-bob-store"
            DJANGO_BASE = "/srv/projects/pyxiebob/website/app"

        except ImportError:
            if os.path.exists('/Users/molt/Documents/pyxie-bob-store'):
                STORE_BASE = '/Users/molt/Documents/pyxie-bob-store'
                DJANGO_BASE = '/Users/molt/Documents/pyxiebob/website/app'
            elif os.path.exists('/Users/mattbr/Store/pyxiebob'):
                STORE_BASE = '/Users/mattbr/Store/pyxiebob'
                DJANGO_BASE = '/Users/mattbr/Sites/pyxiebob/website/app'
            else:
...
TUTORIAL_ASSETS_STATIC_DIRECTORY = DJANGO_BASE + '/pyxiebob/static/pyxiebob/tutorial_assets'

# The word list to use for usernames/passwords
WORD_LIST_FILE = '/usr/share/dict/words'
try:
   import taster_machine
   WORD_LIST_FILE = "/home/pyxiebob/pyxiebob/website/app/app/wordlist"
except ImportError:
   pass
