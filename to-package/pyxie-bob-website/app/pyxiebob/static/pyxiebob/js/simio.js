...
//		imageObj.src = '/static/pyxiebob/media/IMG_9125.png';
		imageObj.src = '/static/pyxiebob/media/PyxieBob.jpg';

		flareObj = new Image();
		flareObj.src = '/static/pyxiebob/media/redledwithalpha_sm.png';

		flareObj2 = new Image();
		flareObj2.src = '/static/pyxiebob/media/orangeledwithalpha_sm.png';
