    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edit_phrase', models.CharField(default=pyxiebob.models.default_edit_phrase, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facilitators', models.ManyToManyField(related_name=b'children', to='pyxiebob.UserProfile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name=b'Created At')),
                ('owner', models.ForeignKey(default=None, blank=True, to='pyxiebob.UserProfile', null=True)),
                ('previous_version', models.ForeignKey(blank=True, to='pyxiebob.Version', null=True)),
                ('program', models.ForeignKey(related_name=b'+', to='pyxiebob.Program', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='program',
            name='owner',
            field=models.ForeignKey(default=None, blank=True, to='pyxiebob.UserProfile', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='program',
            name='version',
            field=models.ForeignKey(related_name=b'+', to='pyxiebob.Version'),
            preserve_default=True,
        ),
    ]
