...
import os
from pyxiebob.models import Tutorial
...
class Command(TemplateCommand):
    ...
    def handle(self, tutorial_directory=None, **options):
        ...
        self._copy_tutorial_assets(os.path.abspath(tutorial_directory)+'/static/pyxiebob/tutorial_assets')
    ...
    def _fix_static_links(self, content):
        return content.replace(
            'static/pyxiebob/tutorial_assets',
            '/static/pyxiebob/tutorial_assets'
        )
    ...
    def _section_marker(self, template_name=None, seenPrevious=False):
        ...
        if template_name is not None:
            replacement += '{% include "pyxiebob/partials/blockly_toolboxes/'+template_name+'.html" %}'
        return replacement
