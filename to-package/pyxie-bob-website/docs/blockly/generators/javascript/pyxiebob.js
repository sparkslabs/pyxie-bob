...
goog.provide('Blockly.JavaScript.pyxiebob');

goog.require('Blockly.JavaScript');

Blockly.JavaScript['pyxiebob_scroll_string'] = function(block) {
...
Blockly.JavaScript['pyxiebob_set_eye'] = function(block) {
...
Blockly.JavaScript['pyxiebob_eye_on'] = function(block) {
  var value_id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['pyxiebob_eye_off'] = function(block) {
  var value_id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['pyxiebob_toggle_eye'] = function(block) {
  var value_id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['pyxiebob_print_message'] = function(block) {
  var value_message = Blockly.JavaScript.valueToCode(block, 'message', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['pyxiebob_show_letter'] = function(block) {
...
Blockly.JavaScript['pyxiebob_get_button'] = function(block) {
  var value_id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['pyxiebob_clear_display'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
  var code = 'clear_display();';
  return code;
};

Blockly.JavaScript['pyxiebob_plot'] = function(block) {
...
Blockly.JavaScript['pyxiebob_unplot'] = function(block) {
  var value_x = Blockly.JavaScript.valueToCode(block, 'x', Blockly.JavaScript.ORDER_ATOMIC);
  var value_y = Blockly.JavaScript.valueToCode(block, 'y', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['pyxiebob_point'] = function(block) {
  var value_x = Blockly.JavaScript.valueToCode(block, 'x', Blockly.JavaScript.ORDER_ATOMIC);
  var value_y = Blockly.JavaScript.valueToCode(block, 'y', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
...
Blockly.JavaScript['pyxiebob_build_image'] = function(block)
{
    var b = "'5,5,";
    for (var c = 0; 5 > c; c++)
    {
...
Blockly.JavaScript['pyxiebob_build_big_image'] = function(block)
{
    var w = 10;
    var h = 5;
...
Blockly.JavaScript['pyxiebob_show_image'] = function(block)
{
...
Blockly.JavaScript['pyxiebob_show_image_offset'] = function(block) {
...
Blockly.JavaScript['pyxiebob_scroll_image'] = function(block) {
  var value_sprite = Blockly.JavaScript.valueToCode(block, 'sprite', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['pyxiebob_get_image_point'] = function(block) {
  var value_id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_ATOMIC);
  var value_x = Blockly.JavaScript.valueToCode(block, 'x', Blockly.JavaScript.ORDER_ATOMIC);
  var value_y = Blockly.JavaScript.valueToCode(block, 'y', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['pyxiebob_set_image_point'] = function(block) {
  var value_id = Blockly.JavaScript.valueToCode(block, 'id', Blockly.JavaScript.ORDER_ATOMIC);
  var value_x = Blockly.JavaScript.valueToCode(block, 'x', Blockly.JavaScript.ORDER_ATOMIC);
  var value_y = Blockly.JavaScript.valueToCode(block, 'y', Blockly.JavaScript.ORDER_ATOMIC);
...
Blockly.JavaScript['pyxiebob_make_StringImage'] = function(block) {
...
Blockly.JavaScript['pyxiebob_scroll_string_image'] = function(block) {
...
Blockly.JavaScript['pyxiebob_logic_onoff_states'] = function(block) {
  var code = (block.getFieldValue('STATE') == 'ON') ? 'ON' : 'OFF';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['pyxiebob_logic_button_states'] = function(block) {
  var code = (block.getFieldValue('STATE') == 'PRESSED') ? 'PRESSED' : 'NOT_PRESSED';
  return [code, Blockly.JavaScript.ORDER_ATOMIC];
};

Blockly.JavaScript['pyxiebob_comment'] = function(block) {
