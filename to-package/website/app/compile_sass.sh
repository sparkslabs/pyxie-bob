...
sass ./sass_src/_bootstrap.scss:pyxiebob/static/pyxiebob/css/bootstrap.css

echo "Compiling Font Awesome"
sass ./sass_src/font-awesome.scss:pyxiebob/static/pyxiebob/css/font-awesome.css

echo "All sass compiled"
terminal-notifier -title "PyxieBob Sass" -message "Finished build of SASS"